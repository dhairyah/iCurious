<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="vbm.aspx.cs" Inherits="vbm" %>
          ...
          <fieldset style="width:250px;">
            ...
            <ItemTemplate>
                ...
                <table style="width:220px;" cellspacing="2" cellpadding="2">
                      <tr>
                        <td><b style="color:#0073c5;">Bookmark Title :</b><div class="bb"><a style="color:#000" href="<%#DataBinder.Eval(Container.DataItem, "Url")%>"> <%#DataBinder.Eval(Container.DataItem, "Title")%></div></td>
                      </tr>
                      <tr>
